...
class DriverWorker(QObject):
    ...
    def open(
        ...
        # The sink is attached before objects_enumerated fires, ensuring no
        # traffic generated by enumerate_objects() is missed.
        sink = _QtFrameSink(self.frame_captured, self._session_id)
        self._session.driver_session.attach_frame_sink(sink)
